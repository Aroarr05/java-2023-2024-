...
// Declaro lista como un array de n variables de tipo int
    ...
    System.out.println("En la lista " + escribirLista(lista) + res.escribirResultado());
    entrada.close();
  }
...
// Declaro la clase Resultado para devolver los 2 valores (max y min) 
  static class Resultado {
      ...
      public String escribirResultado(){
        String varResultado ="";
        varResultado = " el máximo es " + this.max + " y el mínimo es " + this.min;
        return varResultado;
      }
  }
